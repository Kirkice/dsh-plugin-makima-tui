import { Box, type ScrollBoxHandle, stringWidth, Text } from '@makima-tui/ink'
...
export function StatusRule({
  ...
  // Dev-only readout (MAKIMA_TUI_DEV_CREDITS). The server omits the key entirely unless the
