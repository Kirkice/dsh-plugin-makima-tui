 ...
 *
 * Set MAKIMA_TUI_RENDER_DEBUG=1 to record both. Output goes to a FILE, never
 ...
 * override with MAKIMA_TUI_RENDER_DEBUG_FILE.
 */
...
const target = (): string => process.env.MAKIMA_TUI_RENDER_DEBUG_FILE || join(tmpdir(), 'clawcodex-render-debug.log')
