// Stage 2 acceptance: the vendored @makima-tui/ink fork builds and renders headlessly.
...
describe('vendored @makima-tui/ink fork', () => {
  it('renders Box/Text synchronously into a fake TTY', async () => {
    const { Box, Text, renderSync } = await import('@makima-tui/ink')
    ...
    const instance = renderSync(
      createElement(
        ...
        createElement(Text, { color: 'green' }, 'makima-tui smoke')
      ),
    ...
    expect(plain).toContain('makima-tui')
